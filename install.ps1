...
$SCOOP_PACKAGE_REPO = 'ghgo.xyz/https://github.com/ScoopInstaller/Scoop/archive/master.zip'
$SCOOP_MAIN_BUCKET_REPO = 'ghgo.xyz/https://github.com/ScoopInstaller/Main/archive/master.zip'
